...
namespace Projeto_SENAI_10._12
{
    public class Perfil
    {
        ...
        )
        {
            ...
            if (maior != 0)
            {
                Console.WriteLine($"O seu perfl é {perfil}, com pontuação de {maior}");
            ...
            {
                Console.WriteLine("Sua pontuação está zerada, não conseguimos definir um perfil!");
            }

            Console.WriteLine();

            Console.WriteLine("Seus pontos em outros perfis foi:");
            for (int i = 0; i < pontuação.Length; i++)
            {
